--
-- The inserted data rows serve as testing. Delete them manually in a production system setup. They are flagged by the domain localhost.
--
...
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA linkorgs TO linkorgs;
